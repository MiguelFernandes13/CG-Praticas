...
void preparaCilindro(float altura, float raio, int lados) {
	...
	for (int i = 0; i < lados; ++i) {
		...
		t[vertex * 2 + 0] = 0.4375 + (0.625 - 0.4375) * sin(i * delta);
		t[vertex * 2 + 1] = 0.1875 + (0.625 - 0.4375) * cos(i * delta);
		...
		t[vertex * 2 + 0] = 0.4375f + (0.625 - 0.4375) * sin((i + 1) * delta);
		t[vertex * 2 + 1] = 0.1875f + (0.625 - 0.4375) * cos((i + 1) * delta);
		// corpo
		...
		t[vertex * 2 + 0] = 0.8125f + (1 - 0.8125) * sin((i + 1) * delta);
		t[vertex * 2 + 1] = 0.1875f + (1 - 0.8125) * cos((i + 1) * delta);
		...
		t[vertex * 2 + 0] = 0.8125f + (1 - 0.8125) * sin(i * delta);
		t[vertex * 2 + 1] = 0.1875f + (1 - 0.8125) * cos(i * delta);
